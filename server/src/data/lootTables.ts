...
export const LootTables: Record<string, LootTable> = {
    ...
    fridge: {
        ...
        loot: [
            { item: "cola", weight: 1 },
            { item: "blueberry_smoothie", weight: 0.5 }
        ]
    },
    washing_machine: {
        min: 1,
...
export const LootTiers: Record<string, WeightedItem[]> = {
    guns: [
        ...
        { item: "bar", weight: 0.02 },
        { item: "delisle", weight: 0.015 },
    ...
    special_guns: [
        { item: "radio", weight: 2.5 },
        // { item: "micro_uzi", weight: 1.25 },
        { item: "tommy", weight: 1.2 },
